            ...
            {isOpen && unit && (
                <>
                    ...
                    <motion.div
                        ...
                        className="fixed right-0 top-0 bottom-0 w-[900px] max-w-[90vw] bg-white border-l border-slate-200 shadow-2xl z-50 overflow-y-auto"
                    >
                        ...
                        <div className="p-6">
                            {/* Two-column grid for Fleet and People */}
                            <div className="grid grid-cols-1 lg:grid-cols-2 gap-6">
                                ...
                                <section>
                                    <div className="flex items-center gap-2 mb-4 text-slate-700">
                                        ...
                                        <h3 className="uppercase tracking-wider text-sm font-bold">Pessoas ({unit.people.length})</h3>
                                    </div>
                                    ...
                                    <div className="grid gap-3">
                                        ...
                                        {unit.people.map(p => (
                                            <div key={p.id} className="group flex items-center gap-4 bg-white p-4 rounded-xl border border-slate-200 shadow-sm hover:shadow-md hover:border-emerald-200 transition-all">
                                                <div className="bg-emerald-50 p-2.5 rounded-full text-emerald-600 group-hover:bg-emerald-600 group-hover:text-white transition-colors">
                                                    <Users size={18} />
                                                </div>
                                                <div className="flex-1 min-w-0">
                                                    <div className="flex flex-col gap-0.5">
                                                        <span className="text-[10px] text-slate-400 font-bold uppercase tracking-wider">Nome</span>
                                                        <p className="text-slate-800 font-bold text-sm truncate">{p.name}</p>
                                                    </div>
                                                    <div className="flex items-center mt-2">
                                                        <div className="flex flex-col">
                                                            <span className="text-[10px] text-slate-400 font-bold uppercase tracking-wider">Cargo</span>
